// Analyse this program and use " Virtual " Keyword to avoid dimaond problem.
class Person{
...
public:
    Student(int x):Person(int x){
        cout<<"Student"<<x<<"Called"<<endl;
    }
};
class TA:public Faculty, public Student{
public:
    TA(int x): Person(int x),Facult(int x),Student(int x){
